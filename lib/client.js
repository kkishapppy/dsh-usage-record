	...
	factory: (require) => {
		...
		*  [data-conversation-scroll]（F12 布局切换时其 rect 会飘到页面最左工作区）。 */
		function railLayout(ticks) {
			...
			const contentH = Math.max(1, ticks.length * 17 - GAP + PAD * 2);
			const height = Math.min(contentH, 257);
		...
		*/
		...
		function loadUntilVisible(id, onDone) {
			...
			const tick = (tries) => {
				...
				const btn = findLoadOlderBtn();
				if (tries % 4 === 0) console.log("[usage-record] loadUntilVisible try", tries, {
					btn: btn !== null,
		...
		function QuestionRail(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					onMouseEnter: () => {
						setMouseOnRail(true);
						startBackgroundPreload(rail.ticks.length);
					},
					ref: (el) => {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: rail.ticks.map((tick, i) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								style: {
									...
									background: isActive ? "var(--dsw-alias-accent, #4cc2ff)" : isCurrent ? "#7dd3fc" : "var(--dsw-alias-border-l2, rgba(128,128,128,.45))",
				...
				bgLoading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						position: "fixed",
						left: rail.left,
					...
					children: t("rail.loading", { n: bgBatches })
				}),
